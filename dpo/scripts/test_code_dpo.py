...
DEFAULT_DPO_CONFIG = Path("dpo/configs/qwen3_06b_code_predict_dpo.yaml")
DEFAULT_BASE_PREDICTIONS = PROJECT_ROOT / "dpo" / "outputs" / "predict_qwen3_base_on_code_dpo" / "generated_predictions.jsonl"
DEFAULT_DPO_PREDICTIONS = PROJECT_ROOT / "dpo" / "outputs" / "predict_qwen3_dpo_on_code_dpo" / "generated_predictions.jsonl"
